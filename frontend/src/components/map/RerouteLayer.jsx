...
export default function RerouteLayer({ recommendation, stations, hazards, lineId }) {
  ...
  const coords = resolveRouteCoords(approved_route, stations, segmentsById, lineId);
